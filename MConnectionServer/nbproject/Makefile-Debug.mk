...
${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/rpc/messageservice.grpc.pb.o: rpc/messageservice.grpc.pb.cc
	${MKDIR} -p ${OBJECTDIR}/rpc
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rpc/messageservice.grpc.pb.o rpc/messageservice.grpc.pb.cc

${OBJECTDIR}/rpc/messageservice.pb.o: rpc/messageservice.pb.cc
	${MKDIR} -p ${OBJECTDIR}/rpc
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rpc/messageservice.pb.o rpc/messageservice.pb.cc

${OBJECTDIR}/src/AbstractCallData.o: src/AbstractCallData.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AbstractCallData.o src/AbstractCallData.cpp

${OBJECTDIR}/src/ExchangeMessageDataCall.o: src/ExchangeMessageDataCall.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ExchangeMessageDataCall.o src/ExchangeMessageDataCall.cpp

${OBJECTDIR}/src/MessageASyncServer.o: src/MessageASyncServer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessageASyncServer.o src/MessageASyncServer.cpp

${OBJECTDIR}/src/RtMessageModel.o: src/RtMessageModel.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RtMessageModel.o src/RtMessageModel.cpp

${OBJECTDIR}/src/UserConnectionsInfo.o: src/UserConnectionsInfo.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UserConnectionsInfo.o src/UserConnectionsInfo.cpp
...
${TESTDIR}/tests/exchangeMessageClient.o: tests/exchangeMessageClient.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinc -I. -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/exchangeMessageClient.o tests/exchangeMessageClient.cpp
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -I. -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
...
${OBJECTDIR}/rpc/messageservice.grpc.pb_nomain.o: ${OBJECTDIR}/rpc/messageservice.grpc.pb.o rpc/messageservice.grpc.pb.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -I. -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rpc/messageservice.grpc.pb_nomain.o rpc/messageservice.grpc.pb.cc;\
	else  \
...
${OBJECTDIR}/rpc/messageservice.pb_nomain.o: ${OBJECTDIR}/rpc/messageservice.pb.o rpc/messageservice.pb.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -I. -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rpc/messageservice.pb_nomain.o rpc/messageservice.pb.cc;\
	else  \
...
${OBJECTDIR}/src/AbstractCallData_nomain.o: ${OBJECTDIR}/src/AbstractCallData.o src/AbstractCallData.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -I. -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AbstractCallData_nomain.o src/AbstractCallData.cpp;\
	else  \
...
${OBJECTDIR}/src/ExchangeMessageDataCall_nomain.o: ${OBJECTDIR}/src/ExchangeMessageDataCall.o src/ExchangeMessageDataCall.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -I. -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ExchangeMessageDataCall_nomain.o src/ExchangeMessageDataCall.cpp;\
	else  \
...
${OBJECTDIR}/src/MessageASyncServer_nomain.o: ${OBJECTDIR}/src/MessageASyncServer.o src/MessageASyncServer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -I. -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MessageASyncServer_nomain.o src/MessageASyncServer.cpp;\
	else  \
...
${OBJECTDIR}/src/RtMessageModel_nomain.o: ${OBJECTDIR}/src/RtMessageModel.o src/RtMessageModel.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -I. -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RtMessageModel_nomain.o src/RtMessageModel.cpp;\
	else  \
...
${OBJECTDIR}/src/UserConnectionsInfo_nomain.o: ${OBJECTDIR}/src/UserConnectionsInfo.o src/UserConnectionsInfo.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinc -I. -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UserConnectionsInfo_nomain.o src/UserConnectionsInfo.cpp;\
	else  \
